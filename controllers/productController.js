 ...
 * @route   GET /api/products?categoryId=xxx
...
const createProduct = async (req, res, next) => {
  try {
    ...
    // Validate ingredients in recipe if provided
    ...
    // Validate child products in bundle if provided
...
const deleteProduct = async (req, res, next) => {
  try {
    ...
    // Check if product is being used in any bundles
